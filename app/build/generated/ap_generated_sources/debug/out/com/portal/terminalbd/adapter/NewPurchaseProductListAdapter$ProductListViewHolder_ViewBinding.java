...
public class NewPurchaseProductListAdapter$ProductListViewHolder_ViewBinding implements Unbinder {
  private NewPurchaseProductListAdapter.ProductListViewHolder target;

  @UiThread
  public NewPurchaseProductListAdapter$ProductListViewHolder_ViewBinding(
      NewPurchaseProductListAdapter.ProductListViewHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    NewPurchaseProductListAdapter.ProductListViewHolder target = this.target;
