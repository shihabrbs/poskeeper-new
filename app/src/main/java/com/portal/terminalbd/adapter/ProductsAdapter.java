...
public class ProductsAdapter extends RecyclerView.Adapter<ProductsAdapter.MyViewHolder>{
    ...
    public ProductsAdapter(Context context, List<ModelAddProduct> categorys) {
    ...
    public void onBindViewHolder(@NonNull ProductsAdapter.MyViewHolder holder, int position) {
        ...
        holder.catname.setText(categorys.get(position).getName());
        holder.id.setText(""+getItemId(position));

        Glide.with(context)
                .load("http://shihab.techdevbd.com/sokol_bazar/file_upload_api/"+categorys.get(position).getUrl())
                .override(300, 200)
                .into(holder.catimg);
        ...
        holder.delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                apiInterface.deleteProduct(modelAddProduct).enqueue(new Callback<ModelAddProduct>() {
                    @Override
